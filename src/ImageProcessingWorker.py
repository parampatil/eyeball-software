...
class ImageProcessingWorker(QThread):
    ...
    def __init__(self, userInput, folderPath, imageFiles, multiprocessingToggle, processedImages, generate_retina_object):
        super().__init__()
        ...
        self.generate_retina_object = generate_retina_object
        ...
        if self.multiprocessingToggle:
            with ProcessPoolExecutor() as executor:
                ...
                for i, future in enumerate(as_completed(futures)):
                    ...
                    estimated_time = elapsed_time / (i+1) * (len(self.imageFiles) - (i+1))
